  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans selection:bg-sky-500/30 overflow-x-hidden relative transition-colors duration-300">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <main className="container mx-auto px-6 py-12 relative z-10 flex-1 flex flex-col pb-24 md:pb-12">
          {children}
        </main>

        <footer className="border-t border-[var(--border-color)] py-12 relative z-10 bg-[var(--bg-card)]/50 backdrop-blur-sm mt-auto mb-20 md:mb-0">
